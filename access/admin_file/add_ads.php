...
if (isset($_POST["submit"])) {
    ...
    if (move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . $upload_dir . $file_name)) {
        ...
        $sql = "INSERT INTO ads (title, description, image_url, ads_type) VALUES ('$title', '$description', '$image_url', '$ads_type')";
    ...
    <div class="wrapper">
        <div class="form-wrapper sign-in">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="remember">
                    <select name="ads_type" class="form-select" required>
                        <option value="">Chosse Just one </option>
                        <?php
                ...
                <button type="submit" name="submit" onclick="return confirm('Are you sure you want to Add This Ads?')">Add This Ads</button>
            </form>
        </div>
