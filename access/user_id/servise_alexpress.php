...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare the SQL query to insert the user data into the table using prepared statements
    $sql = "INSERT INTO aliexpressorder (Link, ProductName, Quantity, UserID) 
            VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssii", $link, $productName, $quantity, $id);
    ...
    <div class="container">
        <form method="post" action="" id="multiStepForm" enctype="multipart/form-data">
            ...
            <div class="step" id="step2">
                ...
                <input type="text" id="link" name="link" placeholder="Product Link" required>
